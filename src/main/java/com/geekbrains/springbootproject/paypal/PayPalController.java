...
public class PayPalController {
    ...
    public String buy(HttpServletRequest request, HttpServletResponse response, Model model) {
        try {
            ...
            redirectUrls.setCancelUrl("http://localhost:8189/project/paypal/cancel");
            redirectUrls.setReturnUrl("http://localhost:8189/project/paypal/success");
            ...
            transaction.setDescription("Покупка в ProjectMarket");
